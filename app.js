...
app.post('/api/v1/nodes/waypointdistance', nodeAdmin.setWayPointDistance);
app.get('/api/v1/nodes/waypointdistance', nodeAdmin.getWayPointDistance);
...
app.get('/api/v1/nodes/display', nodeAdmin.displayNodesByCoordinate);
app.get('/api/v1/nodes', nodeAdmin.getAllNodes)

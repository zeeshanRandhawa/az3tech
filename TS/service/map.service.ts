...
export class MapService {
    ...
    async displayMapNodesInAreaOfInterest(upperLeftCorner: Array<number>, lowerLeftCorner: Array<number>, upperRightCorner: Array<number>, lowerRightCorner: Array<number>): Promise<Record<string, any>> {

        let nodesToDisplay: Array<Record<string, any>> = await findNodesOfInterestInArea(upperLeftCorner, lowerLeftCorner, upperRightCorner, lowerRightCorner);
